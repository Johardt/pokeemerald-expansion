...
#define ABILITY_TOTAL_IMMUNITY (ABILITIES_COUNT_GEN9 + 1)
#define CUSTOM_ABILITIES_COUNT (ABILITY_TOTAL_IMMUNITY + 1)

#define ABILITIES_COUNT CUSTOM_ABILITIES_COUNT
