...
#define MOVE_STELLAR_STRIKE     (MOVES_COUNT_DYNAMAX + 2)
#define MOVE_STELLAR_BEAM       (MOVES_COUNT_DYNAMAX + 3)
#define MOVE_COSMIC_SHIELD      (MOVES_COUNT_DYNAMAX + 4)

#define LAST_CUSTOM_MOVE         MOVE_COSMIC_SHIELD
